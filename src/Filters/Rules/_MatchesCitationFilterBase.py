...
class MatchesCitationFilterBase(MatchesFilterBase):
    ...
    name        = _('Objects with citation matching the <citation filter>')
    description = _("Matches objects with citations that match the "
    ...
    def apply(self, db, object):
        ...
        for citation_handle in object.get_citation_list():
            if self.MSF_filt.check(db, citation_handle):
                return True
        return False
